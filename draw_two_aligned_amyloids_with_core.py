...
alignment_file = Path("MAFFT_families_atomseq_multiple_alignment/" "family_001_aligned.txt")
angles_file = Path("all_phi_psi.txt")

input_file_1 = "records/10ij.pdb_records.txt"
input_file_2 = "records/7qkh.pdb_records.txt"
...
plot_pairwise_structures_with_core(
    structure_name_1="10ij.pdb",
    structure_name_2="7qkh.pdb",
    alignment=alignment,
